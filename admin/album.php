...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="card mt-2">
                    <div class="card-header text-black bg-subtle">Tambah Album</div>
                    <div class="card-body bg-subtle">
            ...
            <div class="col-md-8">
                <div class="card text-black bg-subtle mb-3" style="max-width: 50rem;">
